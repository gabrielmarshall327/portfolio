...
export const projectsData = [
  {
    title: "Solar Tracker",
    description:
      "A solar-powered system for real-time weather data collection and solar irradiance forecasting. Uses machine learning models (CNN & LSTM) and a web app with data visualization. Placed 2nd in Capstone Expo and is pending a patent.",
    tags: ["React", "Node.js", "PostgreSQL", "Python", "AWS", "Raspberry Pi"],
    buttons: [
      <FaGithub key="solarKey1" />,
      <HiMiniArrowTopRightOnSquare key="solarKey2" />,
    ],
    links: ["https://github.com/Sunsightenergy", "https://sunsightenergy.com/"],
    imageUrl: solarTracker,
  },
  {
